...
def pollster_predictions(poll_rows):
    ...
    for pollster in pollsterSet:
        # To store most recent poll results for every state and current pollster
        recentList = []
        ...
        if len(recentList) > 0:
            output[pollster] = state_edges(recentList)
